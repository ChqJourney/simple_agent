...
class OllamaLLM(BaseLLM):
    ...
    def _build_payload(self, messages: List[Dict], tools: Optional[List[Dict]], stream: bool) -> Dict[str, Any]:
        ...
        if supports_reasoning('ollama', self.model):
            payload['think'] = self.enable_reasoning
        return payload
    ...
    def _convert_chunk_to_openai(self, chunk: Dict) -> Dict:
        ...
        reasoning_content = message.get('thinking') or chunk.get('thinking') or message.get('reasoning_content')
        ...
        return {
            ...
            'choices': [{
                ...
                'message': {
                    ...
                    'content': message.get('content', ''),
                    'reasoning_content': message.get('thinking') or response.get('thinking') or '',
                },
                'finish_reason': 'stop',
            }],
            'usage': {
