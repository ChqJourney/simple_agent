...
SCENARIO_REGISTRY: Dict[str, ScenarioSpec] = {
    ...
    "standard_qa": {
        ...
        "system_prompt_addendum": (
            ...
            "before broad page reads. Do not launch multiple expensive PDF searches or page reads "
            "in parallel against the same document. Narrow scope first, then prefer pdf_read_lines "
            "or a small targeted page range over repeated broad markdown reads. "
