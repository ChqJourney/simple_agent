...
- `Tauri + Rust`：桌面宿主、文件系统授权、Python sidecar 启停、应用更新桥接
...
- `configStore`
  - 持久化模型配置、runtime、tools/skills 设置
...
- 顶栏：工作区名、模型、WS、token usage、timeline
...
- tools/skills 开关都是真实运行时开关，不只是前端隐藏
